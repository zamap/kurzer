...
namespace KuerzerRepositories.Helpers
{
    /// <summary>
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetKuerzerFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(IUserProfileRepository), dbContext => new UserProfileRepository(dbContext)},
                   {typeof(ILinkRepository), dbContext => new LinkRepository(dbContext)},
				   {typeof(IUserApplicationRepository), dbContext => new UserApplicationRepository(dbContext)}
                };
        }
        ...
        {
			_repositoryFactories = GetKuerzerFactories();
        }
