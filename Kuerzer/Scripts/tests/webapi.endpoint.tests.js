(function () {
    ...
    var apiUrls = [
        '/api/UserProfile/RegisterUser?email=ostetic@gmail.com&pwd=Tratat1a',
        '/UserProfile/ConfirmAccount?confirmation=Iq0WW6v3_spR6SHCxWgbVg2&email=ostetic@gmail.com'
